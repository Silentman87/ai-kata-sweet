...
const Register = () => {
    ...
    const handleSubmit = async (e) => {
         e.preventDefault();
         try {
             const regdt = await axios.post(`${import.meta.env.VITE_API_URL}/api/auth/register`, userdt); 
             console.log("✅ Server Response:", regdt.data);
        ...
        <div className='bg-white shadow-xl p-8 rounded-2xl w-full max-w-md'>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <p className='mt-4 text-center text-sm'>
              ...
              <Link to="/" className='ml-2 text-xl text-green-600 hover:underline font-semibold'>
                Login
              </Link>
            </p>
          </form>
